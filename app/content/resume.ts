...
export const resume = {
  ...
  experience: [
    ...
    },
    {
      ...
      points: [
        "Engineered a hybrid RAG system — dense retrieval (E5 embeddings, ChromaDB) fused with sparse BM25 and BGE cross-encoder reranking — across 1,000+ regulatory documents.",
