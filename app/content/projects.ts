...
export const projects: Project[] = [
  {
    ...
    github: "https://github.com/Shauryagulati/suture-ai",
    featured: true,
  },
  {
    slug: "rag-verdict",
    ...
    stack: ["Python", "pytest", "LLM-as-judge", "CI", "Open source (MIT)"],
    problem:
  ...
  },
  {
    ...
    outcome:
      "A small, finished product with a real user problem at its center. It's also proof that I ship outside the Python/ML lane: native Swift, macOS platform quirks, packaging, and distribution, end to end.",
